...
def _build_gold_record(
    ...
    return {
        ...
        "diagram_generator_backend": validated_record["diagram_generator_backend"],
        "diagram_validation_status": validated_record["diagram_validation_status"],
        "diagram_validation_score": validated_record["diagram_validation_score"],
        "opencv_flags": validated_record["opencv_flags"],
        "semantic_validator_model": validated_record["semantic_validator_model"],
        "semantic_validator_reason": validated_record["semantic_validator_reason"],
